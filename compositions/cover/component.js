 ...
 * @property {string} centered=h1 A simple selector such an element or class selector,
 *  representing the centered (main) element in the cover
 * @property {string} space=var(--spacing-16) The minimum space between and
 *  around all of the child elements
 * @property {string} minHeight=100vh The minimum height (block-size) for the **Cover**
 * @property {boolean} noPad=false Whether the spacing is also applied as padding to
