 ...
 * @property {boolean} breakout=false Whether the element is allowed to break out
 *  of the container over which it is positioned
 * @property {string} margin=0 The minimum space between the element and the
 * inside edges of the positioning container over which it is placed
 * (where `breakout` is not applied)
