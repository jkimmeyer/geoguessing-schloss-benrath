 ...
 * @property {string} padding=var(--spacing-16) A CSS `padding` value
 * @property {string} borderWidth=var(--border-thin) A CSS `border-width` value
 * @property {boolean} invert=false Whether to apply an inverted theme.
...
export default class Box extends HTMLElement {
  ...
  get padding() {
    return this.getAttribute('padding') || 'var(--spacing-16)';
  }
